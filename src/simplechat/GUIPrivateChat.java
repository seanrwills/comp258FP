 ...
 * @author bates5561
 */
public class GUIPrivateChat extends javax.swing.JFrame {

    /**
     * Creates new form GUIPrivateChat
     */
    public GUIPrivateChat() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnUpload.setText("Send File");

        jMenu1.setText("File");

        jMenuItem1.setText("Exit Private Message");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIPrivateChat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIPrivateChat().setVisible(true);
            }
        });
    }
