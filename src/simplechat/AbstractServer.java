...
// INSTANCE METHODS *************************************************
  ...
  {//if serverSocket doesn't exist 
    if (!isListening())
    {
      ...
      connectionListener.start();//start() of a method = run()
      //start() means run threaded
...
// METHODS DESIGNED TO BE OVERRIDDEN BY CONCRETE SUBCLASSES ---------
   ...
   *  sent the message.
   */
  //protected means child class has access to this method
  //public withint he object hierarchy
  //Abstract method echo server will use
